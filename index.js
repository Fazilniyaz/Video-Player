...
var playlistData = [
  ...
  PlayerWrapper.innerHTML = `<iframe id="video-player" src="https://player.vimeo.com/video/${videoPlaySectionData[0].vimeoId}" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
  ...
  for (var i=0;i<playlistData.length;i++){
    ...
    PlayListWrapper.innerHTML += `<div onclick="CardClicked('${i}')" id="card${i}" class="playlist-card ${i == 0 ?'active-card':"" }">
  ...
  function CardClicked(index){
    ...
    console.log(videoPlaySectionData[index])

    PlayerWrapper.innerHTML = `<iframe id="video-player" src="https://player.vimeo.com/video/${videoPlaySectionData[index].vimeoId}" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
